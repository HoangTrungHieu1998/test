...
<table cellspacing="0" cellpadding="2" border="1" bordercolor="#000000" style="font:normal 10px Arial">
	...
	<tr>
		...
		<td>Das Werkzeug verwandelt den Text von der jetzigen Auswahl zu Großbuchstaben. Es bewahrt die Elemente wie Bildnisse und Tabellen (Elemente, die keine Textelemente sind).</td>
		<td>-</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td>Das Werkzeug erlaubt, dass der Benutzer Bildnissekarten durch ein Setzen über den Bildnissen schaffen, und schafft dann Gebiete mit verschiedenen Gestalten.</td>
		<td>-</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td>Modulmanager - Aktiviert /Deaktiviert Module von einem drop-down Liste verfügbarer Module.</td>
		<td>-</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td>Fügen Sie Standardtext ein Knopf - Fügt Standardtext (keine Formatierung) in den r.a.d.editor.</td>
		<td>-</td>
	</tr>
	<tr>
		<td align="middle"><img src="<%= this.SkinPath %>Buttons/PasteFromWord.gif"></td>
		<td>Fügen Sie von Word ein Knopf  - Fügt Inhalt Ein, der von Wort kopiert wurde und nimmt heraus das Gewebe unfreundliche. </td>
		<td>-</td>
	</tr>
	<tr>
		<td align="middle"><img src="<%= this.SkinPath %>Buttons/PasteAsHtml.gif"></td>
		<td>Fügen Sie als HTML Knopf - Fügt HTML Code im Inhaltgebiet ein und behält alle HTML-Tags.</td>
		<td>-</td>
	</tr>
	<tr>
		<td align="middle"><img src="<%= this.SkinPath %>Buttons/Undo.gif"></td>
		<td>Rückgängig-Knopf - macht den letzten Arbeitsschritt rckgängig.</td>
		<td>Ctrl+Z</td>
	</tr>
	<tr>
		<td align="middle"><img src="<%= this.SkinPath %>Buttons/Redo.gif"></td>
		<td>Wiederholen-Knopf - wiederholt den letzten Schritt, der rückgängig gemacht 
			wurde.</td>
		<td>Ctrl+Y</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td>Über Dialog - Zeigt die jetzige Version und die Befähigungsunterlagen von r.a.d.editor.</td>
		<td>-</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td>Bild einfgen - fügt ein Bild aus einem vordefinierten Verzeichnis ein.</td>
		<td>Ctrl+G</td>
	</tr>
	<tr>
		<td align="middle"><img src="<%= this.SkinPath %>Buttons/ImageMapDialog.gif"></td>
	...
	<tr>
		...
		<td>Code Elemente einfgen - fügt vorgefertigte Code-Elemente ein.</td>
		<td>-</td>
	</tr>
	<tr>
		<td align="middle"><img src="<%= this.SkinPath %>Buttons/InsertFormElement.gif"></td>
		<td>Fügen Sie Formelement ein - Fügt ein Formelement von einer Drop-Down Liste mit verfügbaren Elementen ein.</td>
		<td>-</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td>Windows Media einfgen - fügt ein Windows Media Objekt (AVI, MPEG, WAV, etc.) 
	...
	<tr>
		...
		<td>Horizontale Linie - fügt eine horizontale Linie bei 
			dem Cursor ein.</td>
		<td>-</td>
	</tr>
	<tr>
