<%@ page language="C#" masterpagefile="~/Administrator/MasterPage.master" autoeventwireup="true" inherits="Administrator_List_DM_SM, App_Web_hmbntz_8" %>
...
<table style="width: 100%">
    <tr>
        ...
        <asp:DropDownList ID="DropDownList3" runat="server" CssClass="button" 
            DataSourceID="SqlDataSourcesubmenu" DataTextField="Menu" 
            DataValueField="id_" AutoPostBack="True" >
        </asp:DropDownList>
        <asp:DropDownList ID="DropDownList1" runat="server" CssClass="button" 
            DataSourceID="SqlDataSourceSubMenuII" DataTextField="Menu" DataValueField="id_">
        </asp:DropDownList>
        <asp:SqlDataSource ID="SqlDataSourceSubMenuII" runat="server" 
            ...
            <SelectParameters>
                <asp:ControlParameter ControlID="DropDownList3" Name="id_" 
...
<table style="width: 100%">
    <tr>
        ...
        <td style="width: 50%; text-align: left">
            <asp:TextBox ID="txtSender" runat="server" Width="549px"></asp:TextBox> + Họ và Tên trong danh sách bên dưới
            </td>
    </tr>
</table>
</asp:Panel>
            ...
            <td style="border: 1px solid #6691b4; height: 28px; background-color: #c9dae8; text-align: center;">
                ...
                <strong>XEM DANH SÁCH MENU: 
                            ...
                            <asp:DropDownList ID="DropDownList2" runat="server" AutoPostBack="True" 
                                DataSourceID="SqlDataSourceSubMenuII_2" DataTextField="Menu" 
                                DataValueField="id_" 
                            ...
                            <asp:SqlDataSource ID="SqlDataSourceSubMenuII_2" runat="server" 
                                ...
                                SelectCommand="Ad_Select_MenuByIdControl" SelectCommandType="StoredProcedure">
                                <SelectParameters>
                                    <asp:ControlParameter ControlID="DropDownList4" Name="id_" 
                                        PropertyName="SelectedValue" Type="Decimal" />
                                </SelectParameters>
                            </asp:SqlDataSource>
                            </strong> </td>
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField  HeaderText="NỘI DUNG">
                            <ItemTemplate>
                                ...
                                <table style="width: 100%">
                                <tr><td style="width: 60px"><asp:Label ID="_lbNane" runat="server" Text="Họ và Tên"></asp:Label>:</td>
                                <td><asp:TextBox ID="_txtName" title="Thay đổi nội dung này !" runat="server" Text='<%# Eval("Name") %>' Width="100%"></asp:TextBox></td>
                                </tr>
                                </table>
                                </asp:Panel>
                                
                                <asp:Panel ID="_pnCode" runat="server" Visible="false">
                                <table style="width: 100%">
                                ...
                                <table style="width: 100%">
                                <tr><td style="width: 60px"><asp:Label ID="_lbLinkHTTP" runat="server" Text="Email"></asp:Label>:</td>
                                <td><asp:TextBox ID="_txtLinkHTTP" title="Thay đổi nội dung này !" runat="server" Text='<%# Eval("LinkHTTP") %>' Width="100%"></asp:TextBox></td>
                                </tr>
                                </table>
                                </asp:Panel>
                                
                                <asp:Panel ID="_pnImg" runat="server" Visible="false">
                                <table style="width: 100%">
                                ...
                                <asp:Panel ID="_pnPrice" runat="server" Visible="false">
                                <table style="width: 100%">                                
                                ...
                                <asp:Panel ID="_pnOp" runat="server" Visible="false">
                                <table style="width: 100%">
