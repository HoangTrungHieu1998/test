<%@ page language="C#" masterpagefile="~/Administrator/MasterPage.master" autoeventwireup="true" inherits="Administrator_SubMenuMMListPrice, App_Web_hmbntz_8" %>
...
<table style="width: 100%">
    <tr>
        ...
        <td style="width: 50%; text-align: left">
            <asp:TextBox ID="txtSender" runat="server" Width="549px"></asp:TextBox> + Tên trong danh sách bên dưới
            </td>
    </tr>
</table>
</asp:Panel>
...
<table style="width: 100%">
    <tr>
        <td style="width: 6%; text-align: right">
            <asp:Label ID="Label2" runat="server" Text="Nội dung eMail"></asp:Label> :
        </td>
        <td style="width: 50%; text-align: left">
<radE:RadEditor ID="txtContentSender" runat="server" AllowThumbGeneration="True" BackColor="White"
    ConvertTagsToLower="True" ConvertToXhtml="False" CopyCssToFormatBlockTool="False" 
    DeleteDocumentsPaths="~/Files/Uploads"
    DeleteFlashPaths="~/Files/Uploads"
    DeleteImagesPaths="~/Files/Uploads"
        ...
        <tr>
            <td style="border: 1px solid #6691b4; height: 28px; background-color: #c9dae8; text-align: center;">
                <table style="width: 100%">
                    <tr>
                        <td>
                <strong>DANH SÁCH GIÁ CỦA PHÒNG: 
                            <asp:DropDownList ID="DropDownList2" runat="server" AutoPostBack="True" DataSourceID="SqlDataSourcesubmenu" DataTextField="Name" DataValueField="id_" OnSelectedIndexChanged="DropDownList2_SelectedIndexChanged"></asp:DropDownList>
                            </strong> </td>
                        <td align="right">
                            &nbsp;
                <strong>
                <asp:Button ID="btThemMoi" runat="server" title="Thêm mới dữ liệu" BackColor="#6691b4" BorderStyle="Solid" BorderWidth="1px" 
                    CssClass="BtDelete" ForeColor="#ffffff" OnClick="btThemMoi_Click" Text="Thêm mới" BorderColor="#f3f1f1" />&nbsp;
                            <asp:Button ID="btCapNhatAll" runat="server" title="Cập nhật các thay đổi nội dung !" BackColor="#6691b4" BorderColor="#f3f1f1" BorderStyle="Solid" BorderWidth="1px" CssClass="BtDelete" ForeColor="#ffffff" Text="Cập nhật" 
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField  HeaderText="NỘI DUNG">
                            <ItemTemplate>
                                ...
                                <table style="width: 100%">
                                <tr><td style="width: 95px"><asp:Label ID="_lbCode" runat="server" Text="Mã SP"></asp:Label>:</td>
                                ...
                                <table style="width: 100%">
                                <tr><td style="width: 95px"><asp:Label ID="_lbLinkHTTP" runat="server" Text="Link"></asp:Label>:</td>
                                ...
                                <table style="width: 100%">                                
                                 <tr><td style="width: 95px"><asp:Label ID="_lbPrice" runat="server" Text="Giá phòng"></asp:Label>:</td>
                                <td><asp:TextBox ID="_txtPrice" title="Giá phòng!" runat="server" Text='<%# Eval("Price") %>' Width="100px"></asp:TextBox>
                                    <asp:Label ID="_lbPriceOf" runat="server" Text="Giá Triple (Child / Adult)"></asp:Label>: 
                                    <asp:TextBox ID="_txtPriceOf" title="Giá Triple (Child / Adult)" runat="server" Text='<%# Eval("PriceOf") %>' Width="100px"></asp:TextBox>
                                </td>
                                </tr>
                                </table>
                                </asp:Panel>

                                 <asp:Panel ID="_pnDate" runat="server">
                                <table style="width: 100%">                                
        ...
        <tr>
            <td style="border: 1px solid #6691b4; height: 28px; background-color: #c9dae8; text-align: center;">
                ...
                <asp:Button ID="btThemMoi2" runat="server" title="Thêm mới dữ liệu" BackColor="#6691b4" BorderStyle="Solid" BorderWidth="1px" 
                    CssClass="BtDelete" ForeColor="#ffffff" OnClick="btThemMoi_Click" Text="Thêm mới" BorderColor="#f3f1f1" />&nbsp;
                            <asp:Button ID="btCapNhatAll2" runat="server" title="Cập nhật các thay đổi nội dung !" BackColor="#6691b4" BorderColor="#f3f1f1" BorderStyle="Solid" BorderWidth="1px" CssClass="BtDelete" ForeColor="#ffffff" Text="Cập nhật" 
                                OnClientClick="return confirm('Bạn có thật sự muốn thay đổi các dữ liệu trên không?');" OnClick="btCapNhatAll_Click" /></strong>&nbsp;
