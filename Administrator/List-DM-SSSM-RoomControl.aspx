<%@ page language="C#" masterpagefile="~/Administrator/MasterPage.master" autoeventwireup="true" inherits="Administrator_List_DM_SSSM_RoomControl, App_Web_hmbntz_8" %>
                    ...
                    <tr>
                        ...
                        <td style="width: 100px; text-align: left">
                            <asp:TextBox ID="TextBox1" runat="server" Width="100px"></asp:TextBox>
                                <ajaxToolkit:CalendarExtender ID="defaultCalendarExtender1" runat="server" TargetControlID="TextBox1" Format="dd/MM/yyyy" />
                            </td>
...
<asp:Button ID="Button4" runat="server" Text="Hiển thị" /></td>
                    </tr>
                </table>
                </asp:Panel>
            </td>
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField  HeaderText="NỘI DUNG">
                            <ItemTemplate>
                                ...
                                <td><asp:HyperLink ID="HyperLink1" NavigateUrl='<%# "List-DM-MMListPrice.aspx?ks=" + Eval("Link") + "&sl=" + Eval("id_Menu") + "&i=" + Eval("id_") %>' Font-Bold="true" ForeColor="Red" runat="server">Cập nhật giá phòng</asp:HyperLink>
                                    </td>
                                </tr>
                                </table>
                                </asp:Panel>
