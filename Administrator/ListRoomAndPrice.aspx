<%@ page language="C#" masterpagefile="~/Administrator/MasterPage.master" autoeventwireup="true" inherits="Administrator_SListRoomAndPriceubMenu, App_Web_2mwsk7nc" %>
...
<table style="width: 100%"> <tr>
        ...
        <td style="width: 50%; text-align: left">
            <asp:Button ID="Button4" runat="server" BorderColor="#f3f1f1" BorderStyle="Solid" 
                BorderWidth="1px" CssClass="button" Font-Bold="True" Font-Size="14px" 
                Height="29px" OnClick="Button4_Click" Text="Gửi eMail" Width="92px" /> Ghi chú: Bạn chọn danh sách eMail cần gửi đến bên dưới, [Check] vào cột đầu tiên
        </td>
    </tr>
</table>
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField  HeaderText="NỘI DUNG">
                            <ItemTemplate>
                                ...
                                <table style="width: 100%">
                                <tr><td style="width: 60px"><asp:Label ID="_lbNane" runat="server" Text="Tiêu đề"></asp:Label>:</td>
                                ...
                                <table style="width: 100%">
                                <tr><td style="width: 60px"><asp:Label ID="_lbCode" runat="server" Text="Mã SP"></asp:Label>:</td>
                                ...
                                <table style="width: 100%">
                                <tr><td style="width: 60px"><asp:Label ID="_lbLinkHTTP" runat="server" Text="Link"></asp:Label>:</td>
                                ...
                                <table style="width: 100%">
                                <tr><td style="width: 60px"><asp:Label ID="_lbImg" runat="server" Text="Hình ảnh"></asp:Label>:</td>
                                ...
                                <table style="width: 100%">                                
                                 <tr><td style="width: 60px"><asp:Label ID="_lbPrice" runat="server" Text="Giá"></asp:Label>:</td>
                                ...
                                <table style="width: 100%">
                                <tr><td style="width: 60px"><asp:Label ID="_lbOp" runat="server" Text="Tùy chọn"></asp:Label>:</td>
