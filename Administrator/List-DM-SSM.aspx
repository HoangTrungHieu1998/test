<%@ page language="C#" masterpagefile="~/Administrator/MasterPage.master" autoeventwireup="true" inherits="Administrator_List_DM_SSM, App_Web_2mwsk7nc" %>
...
<table style="width: 100%">
    <tr>
        ...
        <td style="width: 50%; text-align: left"> 
                            ...
                            <asp:DropDownList ID="DropDownList5" runat="server" CssClass="button" 
                            ...
                            <asp:DropDownList ID="DropDownList3" runat="server" CssClass="button" 
                                DataSourceID="SqlDataSourceSubMenuII" DataTextField="Menu" 
                                DataValueField="id_" AutoPostBack="True" >
                            </asp:DropDownList>


                            <asp:DropDownList ID="DropDownList1" runat="server" CssClass="button" 
                                DataSourceID="SqlDataSourceIII" DataTextField="Menu" DataValueField="id_">
                            </asp:DropDownList>
                            ...
                            <asp:SqlDataSource ID="SqlDataSourceIII" runat="server" 
                                ConnectionString="<%$ ConnectionStrings:strConnection %>" 
                                SelectCommand="Ad_Select_MenuByIdControl" SelectCommandType="StoredProcedure">
                                <SelectParameters>
            ...
            <td>
                <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="SƠ LƯỢC VỀ KS" ItemStyle-Width="20%">
                            <ItemTemplate>
                             <table style="width: 100%">
                                <tr>
