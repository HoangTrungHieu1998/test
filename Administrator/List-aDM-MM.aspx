<%@ page language="C#" masterpagefile="~/Administrator/MasterPage.master" autoeventwireup="true" inherits="Administrator_Ads, App_Web_hmbntz_8" %>
            ...
            <td>
                <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="TÓM TẮT" ItemStyle-Width="20%" Visible="false">
                            <ItemTemplate>
                             <table style="width: 100%">
                                <tr>
