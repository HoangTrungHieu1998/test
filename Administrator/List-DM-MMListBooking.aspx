<%@ page language="C#" masterpagefile="~/Administrator/MasterPage.master" autoeventwireup="true" inherits="Administrator_MMListBooking, App_Web_bltrjxyj" %>
...
<table style="width: 100%">
    <tr>
        <td>
            <asp:Label ID="lbOthers" runat="server" Text=""></asp:Label> 
        </td>
    </tr>
</table>
</asp:Panel>
...
<table style="width: 100%">
    <tr>
        <td style="width: 6%; text-align: right">
            <asp:Label ID="lbMenu" runat="server" Text="Tên loại phòng"></asp:Label> :
        </td>
        <td style="width: 50%; text-align: left">
                <asp:DropDownList ID="DropDownList1" runat="server" CssClass="button" 
                DataSourceID="SqlDataSourcesubmenu" DataTextField="Name" DataValueField="id_">
            </asp:DropDownList>
            <asp:SqlDataSource ID="SqlDataSourcesubmenu" runat="server" ConnectionString="<%$ ConnectionStrings:strConnection %>"
             SelectCommand="Ad_select_DetailMenuByID" SelectCommandType="StoredProcedure">
                <SelectParameters>
                   <asp:QueryStringParameter Name="id_" QueryStringField="i" Type="Decimal" />
                </SelectParameters>
            </asp:SqlDataSource>                            
        </td>
    </tr>
...
<table style="width: 100%">
     <tr>
        ...
        <td style="width: 50%; text-align: left">
            ...
            <asp:TextBox ID="txtPriceOf" runat="server" Width="120px"></asp:TextBox> <em>Lưu ý:</em> Giá định dạng (vd: 2.000.000 VNĐ, 200 $, 200 USD)
            </td>
    </tr>
</table>
</asp:Panel>
...
<table style="width: 100%">
    <tr>
        <td style="width: 115px; text-align: right">
            <asp:Label ID="Label9" runat="server" Text="Ngày bắt đầu"></asp:Label> :
        </td>
        <td style="width: 100px; text-align: left">
            ...
            <asp:Label ID="Label5" runat="server" Text="Ngày kết thúc"></asp:Label> :
        </td>
...
<table style="width: 100%"> <tr>
        ...
        <td style="width: 50%; text-align: left">
            <asp:Button ID="Button1" runat="server" BorderColor="#f3f1f1" BorderStyle="Solid" Visible="false"
            ...
            <asp:Button ID="Button2" runat="server" BorderColor="#f3f1f1" BorderStyle="Solid" 
                BorderWidth="1px" CssClass="button" Font-Bold="True" Font-Size="14px" 
                Height="29px" OnClick="Button2_Click" Text="  Lưu  " Width="77px" Visible="false" />
...
<table style="width: 100%">
    <tr>
        <td style="width: 100px; text-align: right;" width="100px">
            <asp:Label ID="Label4" runat="server" Text="Ngày Booking"></asp:Label> :
        </td>
        <td style="width: 100px; text-align: left" align="left">

<asp:TextBox ID="txtDateBooking" runat="server" Width="100px"></asp:TextBox> 

<ajaxToolkit:CalendarExtender ID="CalendarExtender2" runat="server" TargetControlID="txtDateBooking" Format="dd/MM/yyyy" />
 

            </td>
            
            <td style="width: 50px; text-align: right;" align="right" width="50px">
            <asp:Label ID="Label2" runat="server" Text="Đến"></asp:Label> :
        </td>
        <td style="text-align: left" align="left">

<asp:TextBox ID="txtDateBooking2" runat="server" Width="100px"></asp:TextBox> 

<ajaxToolkit:CalendarExtender ID="CalendarExtender3" runat="server" TargetControlID="txtDateBooking2" Format="dd/MM/yyyy" />
 
            <asp:DropDownList ID="drKhachSan" runat="server"></asp:DropDownList>

 <asp:Button ID="btBookingSearch" runat="server" BorderColor="#f3f1f1" BorderStyle="Solid" 
                BorderWidth="1px" CssClass="button" Font-Bold="True" Font-Size="13px" 
                Height="24px" OnClick="btBookingSearch_Click" Text="Xem danh sách" Width="142px" />
        ...
        <tr>
            <td style="border: 1px solid #6691b4; height: 28px; background-color: #c9dae8; text-align: center;">
                <table style="width: 100%">
                    <tr>
                        <td>
                <strong>DANH SÁCH ĐẶT PHÒNG: 
                            <asp:DropDownList ID="DropDownList2" Visible="false" runat="server" AutoPostBack="True" DataSourceID="SqlDataSourcesubmenu" DataTextField="Name" DataValueField="id_" OnSelectedIndexChanged="DropDownList2_SelectedIndexChanged"></asp:DropDownList>
                            </strong> </td>
                        <td align="right">
                            &nbsp;
                <strong>
                <asp:Button ID="btThemMoi" runat="server" title="Thêm mới dữ liệu" BackColor="#6691b4" BorderStyle="Solid" BorderWidth="1px"  Visible="false"
                    CssClass="BtDelete" ForeColor="#ffffff" OnClick="btThemMoi_Click" Text="Thêm mới" BorderColor="#f3f1f1" />&nbsp;
                            <asp:Button ID="btCapNhatAll" runat="server" title="Cập nhật các thay đổi nội dung !" BackColor="#6691b4" BorderColor="#f3f1f1" BorderStyle="Solid" BorderWidth="1px" CssClass="BtDelete" ForeColor="#ffffff" Text="Cập nhật"  Visible="false"
        ...
        <tr>
            <td>
                <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                    BackColor="White" BorderWidth="1px" BorderStyle="Solid" BorderColor="#6691b4" PageSize="21"
                    CellPadding="3" OnPageIndexChanging="GridView1_PageIndexChanging" OnRowDeleting="GridView1_RowDeleting"
                    OnRowEditing="GridView1_RowEditing" Width="100%" GridLines="Both" RowStyle-BorderColor="#6691b4"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField  HeaderText="NỘI DUNG">
                            <ItemTemplate>
                                ...
                                <table style="width: 100%">
                                <tr><td style="width: 95px"><asp:Label ID="_lbNane" runat="server" Text="Tiêu đề"></asp:Label>:</td>
                                <td><asp:TextBox ID="_txtName" Enabled="false" title="Thay đổi nội dung này !" runat="server" Text='<%# Eval("Name") %>' Width="100%"></asp:TextBox></td>
                                </tr>
                                </table>
                                </asp:Panel>
                                ...
                                <table style="width: 100%">
                                <tr><td style="width: 95px"><asp:Label ID="_lbCode" runat="server" Text="Địa chỉ"></asp:Label>:</td>
                                <td><asp:TextBox ID="_txtCode" title="Thay đổi nội dung này !" Enabled="false" runat="server" Text='<%# Eval("Code") %>' Width="100%"></asp:TextBox></td>
                                </tr>
                                </table>
                                </asp:Panel>
                                ...
                                <table style="width: 100%">
                                <tr><td style="width: 95px"><asp:Label ID="_lbLinkHTTP" runat="server" Text="Email"></asp:Label>:</td>
                                <td><asp:TextBox ID="_txtLinkHTTP" title="Thay đổi nội dung này !" Enabled="false" runat="server" Text='<%# Eval("LinkHTTP") %>' Width="100%"></asp:TextBox></td>
                                </tr>
                                </table>
                                </asp:Panel>
                                ...
                                <table style="width: 100%">
                                <tr><td style="width: 95px"><asp:Label ID="_lbImg" runat="server" Text="Hình ảnh"></asp:Label>:</td>
                                ...
                                <table style="width: 100%">                                
                                 <tr><td style="width: 95px"><asp:Label ID="_lbPrice" runat="server" Text="Ngày đến"></asp:Label>:</td>
                                <td><asp:TextBox ID="_txtPrice" Enabled="false" title="Ngày đến!" runat="server" Text='<%# Eval("Img") %>' Width="100px"></asp:TextBox>
                                    <asp:Label ID="_lbPriceOf" runat="server" Text="Ngày khởi hành"></asp:Label>: 
                                    <asp:TextBox ID="_txtPriceOf" Enabled="false" title="Ngày khởi hành" runat="server" Text='<%# Eval("file") %>' Width="100px"></asp:TextBox>
                                </td>
                                </tr>
                                </table>
                                </asp:Panel>

                                 <asp:Panel ID="_pnDate" runat="server" Visible="false">
                                <table style="width: 100%">                                
                                 <tr><td style="width: 95px"><asp:Label ID="Label6" runat="server" Text="Ngày bắt đầu"></asp:Label>:</td>
                                <td><asp:TextBox ID="_txtDate" title="Ngày bắt đầu tính giá phòng theo mùa này!" runat="server" Text='<%# Common.__date(Eval("sDate"), "vi").Replace("(", "").Replace(")", "").Trim() %>' Width="100px"></asp:TextBox>
                                    <asp:Label ID="Label7" runat="server" Text="Ngày kết thúc"></asp:Label>: 
                                    <asp:TextBox ID="_txtDateOk" title="Ngày kết thúc tính giá phòng theo mùa này" runat="server" Text='<%# Common.__date(Eval("sDateOk"), "vi").Replace("(", "").Replace(")", "").Trim() %>' Width="100px"></asp:TextBox>
                                    <ajaxToolkit:CalendarExtender ID="defaultCalendarExtender1" runat="server" TargetControlID="_txtDate" Format="dd/MM/yyyy" />
                                    <ajaxToolkit:CalendarExtender ID="defaultCalendarExtender2" runat="server" TargetControlID="_txtDateOk" Format="dd/MM/yyyy" />
                                </td>
                                </tr>
                                </table>
                                </asp:Panel>
                                ...
                                <table style="width: 100%">
                                <tr><td style="width: 95px"><asp:Label ID="_lbOp" runat="server" Text="Tùy chọn"></asp:Label>:</td>
                        ...
                        <asp:TemplateField HeaderText="TÓM TẮT" ItemStyle-Width="20%">
                            <ItemTemplate>
                             <table style="width: 100%">
                                <tr>
                        ...
                        <asp:TemplateField HeaderText="XEM">
                            <ItemTemplate>
                                <asp:ImageButton ID="ImageButton2000" runat="server" CausesValidation="False" title="Xem chi tiết mục tin này !"
                ...
                <table style="width: 100%">
                    <tr>
                        ...
                        <td align="right">
                            &nbsp;
                <strong>
                <asp:Button ID="btThemMoi2" runat="server" title="Thêm mới dữ liệu" BackColor="#6691b4" BorderStyle="Solid" BorderWidth="1px" Visible="false"
                    CssClass="BtDelete" ForeColor="#ffffff" OnClick="btThemMoi_Click" Text="Thêm mới" BorderColor="#f3f1f1" />&nbsp;
                            <asp:Button ID="btCapNhatAll2" runat="server" title="Cập nhật các thay đổi nội dung !" BackColor="#6691b4" BorderColor="#f3f1f1" BorderStyle="Solid" BorderWidth="1px" CssClass="BtDelete" ForeColor="#ffffff" Text="Cập nhật"  Visible="false"
                                OnClientClick="return confirm('Bạn có thật sự muốn thay đổi các dữ liệu trên không?');" OnClick="btCapNhatAll_Click" /></strong>&nbsp;
