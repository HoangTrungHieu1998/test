<%@ page language="C#" masterpagefile="~/MasterPage.master" autoeventwireup="true" inherits="__BookitClickBookitViewRoom, App_Web_sonpvf6v" %>
...
<p style="height:21px; vertical-align:middle"><span style="color:Red; font-size: 11px; text-align:"><em><%=Resources.lang.pt %>: <%# Eval("LinkHTTP")%></em></span></p>
...
<div style="font-size: 14px; color:Red; font-weight:bold" ><%# searchPrice(Eval("id_"))%></div>
<a href="<%# Common.UrlSite + Resources.lang.dt + "/" + Eval("Link") + "/i" + Eval("id_") + ".html" %>" class="link_head_new_1" title='<%#Eval("Name") %>'><%=Resources.lang.dphong %></a>
</td>
